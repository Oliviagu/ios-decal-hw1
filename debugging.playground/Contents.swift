...
//: String! need to correspond to words[0]!, since we are forcibly unwrapping and need to make sure values not nil
...
//: let --> constant. Can't increment constant! so had to change let i to var i. also changed function to static type since it doesn't require an instance to be created to invoke the method
...
//: Initialization of dictionary was wrong. also changed var lenA and var lenB to 'let's! changed final return to be true and made it a static :)
